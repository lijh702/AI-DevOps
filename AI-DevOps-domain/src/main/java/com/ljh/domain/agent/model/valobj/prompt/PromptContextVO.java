...
public class PromptContextVO {
    ...
    /**
     * 将上一步工具执行的结果压缩成摘要，传递给AI作为上下文 (由 ToolResultProvider 注入)
     * 原始工具输出（可能很长）
     * ls -la /var/log
     * total 2048
    ...
    private String sshConnectionName;   // SSH 连接名称
    private String sshHost; // SSH 主机地址
    private Integer sshPort;    // SSH 端口
    private String sshUsername; // SSH 用户名
    private String sshConnectionId; // SSH 连接 ID
}
